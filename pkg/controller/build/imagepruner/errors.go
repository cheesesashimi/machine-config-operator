...
// indicating that a given manifest is not found. This also handles the Quay.io
// edgecase of an image being deleted and Quay returning an HTTP 500 indicating
// that.
